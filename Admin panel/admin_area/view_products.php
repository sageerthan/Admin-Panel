                        ...
                        if(mysqli_num_rows($result)>0) 
                        {
                            foreach($result as $items)
                            {
                                ...
                                <tr>
                                    ...
                                    <td><?=$items['price'];?></td>
                                    <td><?=getProductCategory($connection,$items['product_id'])?></td>
                                    <td>
                                        <button class="btn"><a href="product_details.php? id=<?=$items['product_id']; ?>">View full info<i class='bx bx-fast-forward'></i></a></button>
...
<?php
   ...
   function getProductCategory($connection, $id) {
    ...
    $query = "select sc.category_name as main, pt.product_name as sub from category sc, products pt where sc.category_id = pt.category_id and product_id = $id ";
    $result = mysqli_query($connection, $query);
